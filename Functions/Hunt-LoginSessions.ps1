function Hunt-LoginSessions {
    ...
    .Example 
        Hunt-LoginSessions 
        Hunt-LoginSessions SomeHostName.domain.com
        Get-Content C:\hosts.csv | Hunt-LoginSessions
        Hunt-LoginSessions -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Hunt-LoginSessions
