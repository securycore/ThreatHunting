function Hunt-LocalGroupMembers {
    <#
    .Synopsis 
    ...
    .Example 
        Hunt-LocalGroupMembers 
        Hunt-LocalGroupMembers SomeHostName.domain.com
        Get-Content C:\hosts.csv | Hunt-LocalGroupMembers
        Hunt-LocalGroupMembers $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Hunt-LocalGroupMembers
