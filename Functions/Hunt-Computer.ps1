Function Hunt-Computer {
    ...
    .Example
        Hunt-Computer 
        Hunt-Computer SomeHostName.domain.com
        Get-Content C:\hosts.csv | Hunt-Computer
        Hunt-Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Hunt-Computer
